...
export class TeamComponent implements OnInit {
  ...
  users: User[] = [
    {id: 0, name: 'David Hieselmayr', beschreibung: 'alt', imgurl: 'assets/images/placeholder/images/Portrait_acele.webp'},
    {id: 1, name: 'John Lim', beschreibung: 'kreativ', imgurl: 'assets/images/placeholder/images/Portrait_aliiz.webp'},
    {id: 2, name: 'Fabian Häubl', beschreibung: 'sport', imgurl: 'assets/images/placeholder/images/Portrait_andre.webp'},
    {id: 3, name: 'Florian Beckerle', beschreibung: 'implo', imgurl: 'assets/images/placeholder/images/Portrait_annete.webp'}
  ];
